...
<section>
    <div class="container pt-3">
       <a href="{{route('register')}}"> <img src="{{asset('assets/img/tasker.jpg')}}" class="tasker-img"></a>
        <a href="{{route('register')}}"><img src="{{asset('assets/img/customer.jpg')}}" class="customer-img float-end"></a>
    </div>
    <div class="container tasker-customer pt-5">
        <h1 class="tasker-title float-start">Tasker</h1>
        <h1 class="customer-title float-end">Customer</h1>
    </div>
</section>
</body>
</html>
