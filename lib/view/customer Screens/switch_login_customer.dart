...
import 'package:ieee_app/view/customer%20Screens/login%20screen/view/loginview.dart';
import 'package:ieee_app/view/customer%20Screens/signup/view/signup_customer_view.dart';

class SwitchSignUpLoginCustomer extends StatefulWidget {
  const SwitchSignUpLoginCustomer({super.key});

  @override
  State<SwitchSignUpLoginCustomer> createState() =>
      _SwitchSignUpLoginCustomerState();
}

class _SwitchSignUpLoginCustomerState extends State<SwitchSignUpLoginCustomer> {
  bool isPreesed = true;
  @override
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            isPreesed ? const LoginViewCustomer() : const CustomerSignUp(),
          ],
        ),
      ),
    );
