...
class ForgetPasswordViewCustomer extends StatefulWidget {
  const ForgetPasswordViewCustomer({super.key});

  @override
  State<ForgetPasswordViewCustomer> createState() =>
      _ForgetPasswordViewCustomerState();
}

class _ForgetPasswordViewCustomerState
    extends State<ForgetPasswordViewCustomer> {
  @override
