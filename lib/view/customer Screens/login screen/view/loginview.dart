...
class LoginViewCustomer extends StatefulWidget {
  const LoginViewCustomer({super.key});

  @override
  State<LoginViewCustomer> createState() => _LoginViewCustomerState();
}

class _LoginViewCustomerState extends State<LoginViewCustomer> {
                    ...
                    TextButton(
                      onPressed: () {
                        Navigator.pushReplacementNamed(
                            context, RouteManager.forgetPasswordRouteCustomer);
                      },
                      child: const Text(
