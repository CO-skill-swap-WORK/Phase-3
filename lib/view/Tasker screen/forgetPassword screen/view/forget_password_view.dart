...
class ForgetPasswordViewTasker extends StatefulWidget {
  const ForgetPasswordViewTasker({super.key});

  @override
  State<ForgetPasswordViewTasker> createState() =>
      _ForgetPasswordViewTaskerState();
}

class _ForgetPasswordViewTaskerState extends State<ForgetPasswordViewTasker> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBarCutome.appBar(
        context,
        whichRoute: RouteManager.switchTaskerRoute,
      ),
      body: _body(),
    );
  }
